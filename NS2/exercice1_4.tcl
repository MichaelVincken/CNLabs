...
# Trace file
set tf [open oef1_4.out.tr w]
$ns trace-all $tf

# NAM tracefile
set nf [open oef1_4.out.nam w]
$ns namtrace-all $nf
...
$ns simplex-link $n3 $n4 100kb 0.2ms DropTail           #Upload
$ns simplex-link $n4 $n3 512kb 0.2ms DropTail           #Download
